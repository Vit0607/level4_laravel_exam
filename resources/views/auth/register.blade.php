...
{{--                                    </div>--}}
                                    <form id="js-login" novalidate="" action="{{ route('register_process') }}" method="post">
                                        @csrf

                                        <div class="form-group">
                                            <label class="form-label" for="username">Имя</label>
                                            <input name="name" type="text" id="username" class="form-control" placeholder="Имя" required>
                                        </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="passwordconfirmation">Подтверждение пароля<br></label>
                                            <input name="password_confirmation" type="password" id="passwordconfirmation" class="form-control" placeholder="Подтвержение пароля" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
